...
//            // StoreData();
//            {
//                TerrainGenerator.StoreMap(Application.dataPath + "S1", GameObject.Find("DesertGold10").GetComponent<TerrainCollider>().terrainData);
//                TerrainGenerator.StoreMap(Application.dataPath + "S2", GameObject.Find("DesertGold11").GetComponent<TerrainCollider>().terrainData);
//                TerrainGenerator.StoreMap(Application.dataPath + "S3", GameObject.Find("DesertGold12").GetComponent<TerrainCollider>().terrainData);
//                TerrainGenerator.StoreMap(Application.dataPath + "S4", GameObject.Find("DesertGold13").GetComponent<TerrainCollider>().terrainData);
//                TerrainGenerator.StoreMap(Application.dataPath + "S5", GameObject.Find("DesertGold14").GetComponent<TerrainCollider>().terrainData);
...
//            GameObjectData gdt = SaveLoad.ReadJSONFromResources("City3", "City/");
...
//            SaveLoad.StoreGameObjectsJSON(Application.dataPath, "StartCity666.json", "City");
//            Debug.Log(Application.dataPath);
//           // TerrainGenerator.StoreMap(Application.dataPath + "CityTerr111", Terrain.activeTerrain.terrainData.GetHeights(0, 0, 129, 129));
//            Debug.Log("DataStored");
//        }
